...
public class DataGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Customer customer1 = new Customer("smith","Mike","Smith","smith@comp.com","VA");

        payment1.setCustomer(customer1); // payment1 and payment2 belongs to customer1
        payment2.setCustomer(customer1);
        customerRepository.save(customer1);

        payment1.setMerchant(merchant1); // payment1 and payment2 belongs to merchant1
